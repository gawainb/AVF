...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"org.apache.CollegeSelector launchOptions = %@", url);
    }    
...
// only valid if org.apache.CollegeSelector-Info.plist specifies a protocol to handle
